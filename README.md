...
This all seems to be somehow deprecated:
	...
	./bin/deprecated | sed "2d" | md-table-header | md-escape-emphasis | md-table | pandoc --standalone | 2html
...
|dojox/data/HtmlTableStore|Deprecated|1|
...
|dojox/form/DropDownSelect|Deprecated|7|
...
|dojox/form/FileUploader|Deprecated|3|
...
|dojox/layout/RotatorContainer|-|4|
...
|dojox/mobile/FixedSplitterPane|-|1|
